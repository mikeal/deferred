...
import traceback
# modification : warnings is only used in the file lock deferred
# import warnings
...
# modification : mergeFunctionMetadata from twisted.python.util.mergeFunctionMetadata
import new, inspect
...
# modification : DeferredFilesystemLock requires the reactor
